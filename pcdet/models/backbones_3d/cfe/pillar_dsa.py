...
class PillarContext3D_dsa(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        """
        # print('PillarContext3D_dsa started')
        ...
        # for i, pc in enumerate(pillar_context):
        #     print(f"pillar_context[{i}] type: {type(pc)}, shape: {pc.shape}, device: {pc.device}")
        # print('PillarContext3D_dsa finished')
        return batch_dict
